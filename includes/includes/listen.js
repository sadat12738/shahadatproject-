...
const _0x37bee5 = (await _0x33b434.getNameUser(_0x406b57.id)) || "SHAHADAT SAHU";
...
let _0x133d0a = "==SHAHADAT CHAT BOT==\n\n";
...
const _0x3f60a7 = (await _0x33b434.getNameUser(_0x597a64.id)) || "SahuHun Yar";
...
let _0x7ae436 = "==SHAHADAT CHAT BOT==\n\n";
...
(async function () {
try {
_0x5cbfc5(global.getText("listen", "startLoadEnvironment"), "[ SHAHADAT SAHU ]");
...
_0x5cbfc5(global.getText("listen", "successLoadEnvironment"), "[ sahu]");
} catch (_0x1e847f) {
return _0x5cbfc5.loader(global.getText("listen", "failLoadEnvironment", _0x1e847f), "error");
}
})();
_0x5cbfc5("[ " + global.config.PREFIX + " ] • " + (!global.config.BOTNAME ? '' : global.config.BOTNAME), "[ SHAHADAT SAHU ]");
...
let _0x49c9ee = await _0x11ee72(0x1eea3c.split(''));
...
_0x432ea1.removeUserFromGroup(event.senderID, event.threadID);
return;
}
...
// New unsend reaction (from first file)  
  ...
  if (  
    ...
    event.senderID === _0x432ea1.getCurrentUserID() &&  
    adminBots.includes(event.userID)  
  ) {  
    _0x432ea1.unsendMessage(event.messageID);  
  }  
} catch (error) {  
